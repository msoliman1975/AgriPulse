  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-0.5 px-2">
        ...
        />
        {/* /labs/map is the single Farm-management surface in nav. The legacy
            map experience (/labs/map-legacy) is delisted but still routed —
            the new console's "Edit AoI" deep-links into it until AoI/polygon
            editing reaches parity there. TODO(nuke-legacy-farms): drop
            /labs/map-legacy + /farms/* routes once AoI-edit lands. */}
        <SideNavItem
