"""Shared fixtures for backfill-console integration tests.

Mirrors the per-package pattern used by the farms/imagery/weather suites:
mount just this module's router on a fresh app behind a stubbed auth
middleware, so the route path (including the capability dependency) is
exercised end-to-end without Keycloak.
"""
